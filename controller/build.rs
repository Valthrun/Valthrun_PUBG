...
<assembly xmlns="urn:schemas-microsoft-com:asm.v1" manifestVersion="1.0">
  <description>PubgValthrun</description>
  <assemblyIdentity type="win32" name="dev.wolveringer.valthrun.pubg.controller" version="0.4.5.0" />
            ...
            match { Command::new("git").args(&["rev-parse", "HEAD"]).output() } {
                ...
                Err(error) => {
                    if error.kind() == ErrorKind::NotFound {
                        ...
                        #[cfg(target_os = "linux")]
                        eprintln!("\n\nBuilding the controller requires git to be installed and available in PATH.\nPlease install git using your distribution's package manager.\n\n");
